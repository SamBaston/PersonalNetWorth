...
## This branch
For this branch we used Claude AI's sonnet 4.6 model and used the following initial prompt:
...
Interestingly, at the beginning of the response process, claude asked me two multiple-choice style questions in the GUI:

![Q1](prompt_screenshots/oneshotQ1.png)
![Q2](prompt_screenshots/oneshotQ2.png)

Respecting the 'one-shot' nature of the test, I chose 'no response' as the answer to the questions, and it converted the answers into the following additional prompt:

```
Q: What do you need help with? (Select all that apply)
A: [No preference]

Q: How far along are you?
A: [No preference]
```
It then gave me this resposnse

![Q2](prompt_screenshots/oneshot_response.png)
