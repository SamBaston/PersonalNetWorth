...
This branch of the project was created by GoogleAIStudio using the following initial prompt:
...
The initial project created using the standard npm install npm start combo.
