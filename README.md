...
This branch of the project was created by z.ai's GLM-5 agent mode using the following initial prompt:
...
The initial project created could not be run locally, and needed refinement for the starting process. It now runs using the standard npm install npm start combo.

It has met the cirteria given to it, however, the style and quality leaves a lot to be desired. Without additional refinement, this is not a passable project, but has provided at least a useable application.
